...
export default function DesignerProfile() {
  ...
  const associateId = me ? `XNL-DESN-${String(me.user_id || "").slice(-5).padStart(5, "0")}` : "—";
        ...
        <ScrollView contentContainerStyle={{ paddingBottom: 130 }} showsVerticalScrollIndicator={false}>
          <View style={{ paddingHorizontal: 20, paddingTop: 8 }}>
              ...
              <View style={{ flex: 1, marginLeft: 14 }}>
                ...
                <View style={styles.idChip}>
                  ...
                  <View style={{ marginLeft: 6 }}>
                    <Text style={styles.idLbl}>Designer ID</Text>
            ...
            <View style={styles.card}>
              ...
              <InfoRow icon={<ShieldCheck size={18} color="#D88D07" />} label="RERA Registration No." value={me?.rera_no || me?.rera_no || "RAJ/RA/2024/5678"} />
              <InfoRow icon={<CalendarBlank size={18} color="#D88D07" />} label="Date of Joining" value={joinDate} />
              <InfoRow icon={<Buildings size={18} color="#D88D07" />} label="Department" value={me?.department || "Interior Design"} />
